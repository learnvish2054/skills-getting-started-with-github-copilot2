...
activities = {
    ...
    "Soccer Team": {
        "description": "Outdoor soccer training, drills, and competitive matches",
    ...
    # Artistic activities
    "Art Club": {
        "description": "Painting, drawing, and mixed media open studio",
        "schedule": "Wednesdays, 3:30 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["mia@mergington.edu", "charlotte@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting rehearsals, workshops, and school productions",
    ...
    "Debate Team": {
        "description": "Competitive debating practice and tournaments",
